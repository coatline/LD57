...
[VolumeComponentMenu("Post-processing Custom/DepthFog")]
[VolumeRequiresRendererFeatures(typeof(DepthFogRendererFeature))]
[SupportedOnRenderPipeline(typeof(UniversalRenderPipelineAsset))]
public sealed class DepthFogVolumeComponent : VolumeComponent, IPostProcessComponent
{
    public DepthFogVolumeComponent()
    {
        displayName = "DepthFog";
    }
    ...
    {
        return intensity.GetValue<float>() > 0.0f && isEnabled.value;
    }
}
