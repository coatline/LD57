...
public class PixelEffectRendererFeature : ScriptableRendererFeature
{
    class PixelEffectPass : ScriptableRenderPass
    {
        const string m_PassName = "PixelEffectPass";
    ...
    PixelEffectPass m_ScriptablePass;

    /// <inheritdoc/>
    public override void Create()
    {
        m_ScriptablePass = new PixelEffectPass();
